...
sleep(3)
#encontrar o campo didgite seu nome
campo_digite_nome = driver.find_element(By.ID,'dadosusuario')
sleep(1)
# digitar o nome 
campo_digite_nome.send_keys('Thiago')
sleep(1)
#encontrar o botão clique aqui
